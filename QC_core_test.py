...
def QC_Core(IsSubHourly, measurementFrame, configFrame):
    ...
    configData = tds.getQAConfigDataFromFile('sample_QA_metadata/QA_metadata_sample_SM.csv')
...
if __name__ == "__main__":
    ...
    if testMode:
        ...
        dh = DataHandler()
        frame, configData = dh.getData(True)
        frame = df_result[['MeasurementID', 'StreamId', 'StartDateTime', 'QF01', 'QF02', 'QF03', 'QF04', 'QOverall']]
        computedQFlagFrame, subHourlyAggregations = QC_Core(True, frame, configData)
        dh.PutData(True, computedQFlagFrame)
